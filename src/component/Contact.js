            ...
            <div className="md:px-20 px-4 py-8">
                <div className="flex items-center justify-between py-10">
                    <div className="lg:hidden text-white" >
                            ...
                            <svg id="open" onClick="MenuHandler(true)" aria-haspopup="true" aria-label="Main Menu" xmlns="http://www.w3.org/2000/svg" className="-m-menu icon icon-tabler icon-tabler-menu" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
